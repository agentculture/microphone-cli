...
type: command
description: >
  microphone-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in microphone-cli, handling

...
Every failure inside microphone-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`microphone_cli.cli._output`,
...
# Exit-code policy. Documented in ``microphone-cli learn`` output.
# 0      = success
